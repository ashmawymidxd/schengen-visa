  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-full shadow-2xl shadow-blue-500/30 animate-float"
        ...
        <div
          className="absolute top-20 right-40 w-1 h-1 bg-cyan-300 rounded-full animate-shooting-star"
          style={{ animationDelay: "3s" }}
        ></div>

        {/* Nebula Effects */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-600/20 to-pink-600/20 rounded-full blur-3xl"></div>
      ...
      {/* Main Content */}
      <div
        className={`relative z-10 text-center text-white max-w-2xl mx-auto px-6 transform transition-all duration-1000 ${
          isVisible
      ...
      >
        ...
        <div className="relative mb-8">
          <div className="text-9xl font-bold bg-gradient-to-br from-white via-cyan-200 to-blue-300 bg-clip-text text-transparent drop-shadow-2xl">
            404
          </div>
          <div className="absolute inset-0 text-9xl font-bold bg-gradient-to-br from-cyan-400 to-blue-500 bg-clip-text text-transparent opacity-70 blur-sm animate-pulse">
            404
          </div>
          <Sparkles className="absolute -top-4 -right-4 w-12 h-12 text-cyan-400 animate-bounce" />
          <Sparkles
            className="absolute -bottom-4 -left-4 w-10 h-10 text-blue-400 animate-bounce"
        ...
        {/* Error Message */}
        <div className="mb-8">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
            Lost in Space?
          </h2>
        ...
        <div className="relative mb-8 w-48 h-48 mx-auto">
          ...
          <div className="absolute inset-4 bg-gradient-to-br from-cyan-600/30 to-blue-600/30 rounded-full animate-spin-slow"></div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            ...
            className="group inline-flex items-center gap-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 text-white font-semibold text-lg px-8 py-4 rounded-2xl shadow-2xl shadow-blue-500/10 hover:shadow-blue-500/20 transform hover:scale-105 transition-all duration-300 ease-out"
          >
      ...
      {/* Space Station */}
      <div
        className="absolute top-10 left-10 text-4xl animate-float"
