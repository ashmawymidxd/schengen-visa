...
function HotelReservationFQA() {
  ...
  const faqs = [
    {
      question: t("hotel.reservation.faqs1.question"),
      answer: t("hotel.reservation.faqs1.answer"),
      icon: "🏨",
    },
    {
      question: t("hotel.reservation.faqs2.question"),
      answer: t("hotel.reservation.faqs2.answer"),
      icon: "🛎️",
    },
    {
      question: t("hotel.reservation.faqs3.question"),
      answer: t("hotel.reservation.faqs3.answer"),
      icon: "📅",
    },
  ];
  return (
...
export default HotelReservationFQA;
