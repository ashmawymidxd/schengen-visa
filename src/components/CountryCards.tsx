      ...
      <div className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        {schengenCountries.map((country, idx) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 rounded-2xl blur-md opacity-0 group-hover:opacity-100 transition-all duration-500"></div>
            
            {/* Main Card */}
            <div className="relative z-10 flex flex-col items-center justify-center bg-gradient-to-br from-white to-gray-50/80 backdrop-blur-sm border border-gray-200/60 rounded-2xl p-4 hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-200/60 hover:scale-105 transition-all duration-500 ease-out cursor-pointer">
              ...
              <div className="relative mb-3 transform group-hover:scale-110 group-hover:-translate-y-1 transition-transform duration-500">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-400/30 to-cyan-400/30 rounded-xl blur-sm group-hover:blur-md transition-all duration-500"></div>
                ...
                {/* Corner Accents */}
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
              ...
              {/* Hover Effect Line */}
              <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full group-hover:w-3/4 transition-all duration-500 ease-out"></div>

              {/* Additional Info on Hover */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                <div className="text-center opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-500">
                  <div className="w-1 h-1 bg-cyan-500 rounded-full mx-auto mb-1"></div>
                </div>
              </div>
            </div>
          </div>
