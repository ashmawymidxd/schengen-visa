        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="relative group">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-cyan-600 to-sky-600 rounded-3xl shadow-2xl shadow-blue-500/30 transform group-hover:scale-101 transition-transform duration-500"></div>
